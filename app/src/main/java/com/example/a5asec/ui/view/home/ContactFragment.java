...
//        {
//
//        double lat = Double.parseDouble(mSettingViewModel.getSetting().getValue().getMData()
//        .getDefaultLat());
//        double lang = Double.parseDouble(mSettingViewModel.getSetting().getValue().getMData()
//        .getDefaultLang());
//
...
//                .title("Apple"));
//
//        googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(37.4233438, -122
//        .0728817), 10));
//
//        }
    ...
    public void onMapReady(@NonNull GoogleMap googleMap)
    {
        ...
        try {
            String latitudeString = mSettingViewModel.getSetting().getValue().getMData()
                    .getDefaultLat();
            String langString = mSettingViewModel.getSetting().getValue().getMData()
                    .getDefaultLang();
